        ...
        <section class="appliance-list">
            <ul>
                ...
                <li class="list">
                    ...
                    <li class="list">
                        <div class="appliance-item">
                            <img class="icon" src="iconimage/agriculture.png" alt="agriculture_icon">
                        </div>
...
// $q="CREATE TABLE Garbage (
//     id INT AUTO_INCREMENT PRIMARY KEY,
//     User_Id VARCHAR(10), 
//     Datea DATE, -- This is the foreign key
//     garbage_meta_count DECIMAL(10,2) 
   
//     -- other columns related to vehicle
...
if ($_SERVER["REQUEST_METHOD"] == "POST"&& isset($_SESSION['email'])) {
    ...
    //$id_user="select User_Id from garabage ";
    // Check if the record for the current date exists
    $checkQuery = "SELECT garbage_meta_count FROM garbage WHERE  User_Id = ? AND Datea = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        if ($metacount != $existingMetaCount) {
            ...
            $updateQuery = "UPDATE garbage SET garbage_meta_count = ? WHERE User_Id= ? AND Datea = ?";
        ...
        $insertQuery = "INSERT INTO garbage (User_Id,Datea, garbage_meta_count) VALUES (?, ?,?)";
